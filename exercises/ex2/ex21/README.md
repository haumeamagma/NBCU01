# Exercise 2.1 - Copy integration flow template
...
3. Use _Filter_ with **SOLUTION* to find  the package **D-Com 2023 H0O10 - Solution** and navigate to the artifacts tab.
...
Continue to - [Exercise 2.2](/exercises/ex2/ex22)
